...
import ch.beerpro.presentation.profile.mybeerrefrigerated.FridgeActivity;
...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        model.getMyFridges().observe(this, this::updateMyFridgeCount);
    ...
    private void updateMyFridgeCount(List<Fridge> fridges){
